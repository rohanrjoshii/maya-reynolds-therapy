...
export default function AppointmentCta() {
  ...
  return (
    <section id="contact" className="py-20 md:py-32 px-[5vw] transition-colors duration-300" style={{ background: "var(--color-section-alt)" }}>
      <div className="w-full max-w-[1720px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 xl:gap-24 items-center">
          ...
          <div>
            ...
            <h2
              className="text-[34px] sm:text-[44px] md:text-[52px] lg:text-[58px] leading-[1.14] font-normal mb-8 tracking-[-0.015em]"
            ...
            <div className="space-y-5 mb-10" style={{ color: "var(--color-text)", fontFamily: "var(--font-body)" }}>
              {isRedesign ? (
                <>
                  <p className="text-[16px] sm:text-[17.5px] leading-[1.8] font-light">
            ...
            {isRedesign ? (
              <a
                ...
                className="btn-pill bg-[#1A352F] text-[#FBF9F5] border-[#1A352F] hover:bg-[#BA6A4B] hover:border-[#BA6A4B] px-10 py-4 text-[11.5px] tracking-[0.2em] shadow-sm inline-block"
              >
                Book a Consultation
              </a>
            ) : (
              <a
                href="#contact"
                className="btn-pill bg-transparent text-[#2B2B2B] border-[#2B2B2B] hover:bg-[#2B2B2B] hover:text-[#F6F4EE] px-10 py-4 text-[11.5px] tracking-[0.2em] inline-block"
              >
                Book an Appointment
              </a>
            )}
          ...
          <div className="grid grid-cols-2 gap-5 md:gap-7">
            <div className="grainy-image relative aspect-[3/4.2] shadow-md">
              <Image
                src={isRedesign ? "/images/redesign-cta-stones.jpg" : "/images/original/shells1.jpg"}
                alt={isRedesign ? "Naturally balanced zen stones on peaceful coastal sand" : "Person picking up seashells on a sandy beach"}
                fill
                className="object-cover"
                sizes="(max-width: 768px) 50vw, 25vw"
              />
            </div>
            <div className="grainy-image relative aspect-[3/4.2] mt-10 md:mt-16 shadow-md">
              <Image
                src={isRedesign ? "/images/redesign-cta-boardwalk.jpg" : "/images/original/shells2.jpg"}
                alt={isRedesign ? "Coastal boardwalk leading toward peaceful ocean sunset" : "Parent and child exploring shells on the beach"}
                fill
                className="object-cover"
                sizes="(max-width: 768px) 50vw, 25vw"
              />
